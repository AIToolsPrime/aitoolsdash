...
.review-section .pros, .review-section .cons { background: rgba(128,128,128,0.22); border: 1px solid var(--border); padding: 14px 16px; border-radius: var(--radius-sm); font-size: 0.82rem; }
